...
- Add more utility functions  
  See e.g.:
  - fp-ts' [Array](https://gcanti.github.io/fp-ts/modules/Array.ts.html) module
  - Purescript's [sized-vectors](https://pursuit.purescript.org/packages/purescript-sized-vectors) package

## Inspiration

- Purescript's [sized-vectors](https://pursuit.purescript.org/packages/purescript-sized-vectors) package
- Dependently typed languages like [Idris](https://www.idris-lang.org/)
